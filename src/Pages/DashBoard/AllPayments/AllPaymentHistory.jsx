  ...
  return (
    <div className="bg-gray-100 lg:px-[50px] lg:py-4 max-h-screen">
      <div className="bg-white rounded-lg p-6">
        ...
        <div className="overflow-x-auto lg:overflow-x-hidden mt-6 rounded-lg drop-shadow-xl max-h-[80vh] overflow-y-auto border-[5px] border-[#D1A054] rounded-lg">
